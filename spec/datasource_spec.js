...
describe('GenericDatasource', function() {
    ...
    //     var result = ctx.ds.mapToTextValue({data: {checks:["zero", "one", "two"]}});
    ...
    //     var data =  {chekcs:[{'type': 'string', 'text': 'One', 'key': 'one'}, {'type': 'string', 'text': 'two', 'key': 'Two'}]};
    ...
    //     var data =  {checks:[{'key': 'eins', 'text': 'Eins!'}, {'key': 'zwei', 'text': 'Zwei'}, {'key': 'drei', 'text': 'Drei!'}]};
